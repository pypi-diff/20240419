# Comparing `tmp/pyquantimclient-1.0.85.tar.gz` & `tmp/PyQuantimClient-1.0.9.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "pyquantimclient-1.0.85.tar", last modified: Fri Apr 19 02:49:10 2024, max compression
+gzip compressed data, was "PyQuantimClient-1.0.9.tar", last modified: Mon Dec 19 20:05:36 2022, max compression
```

## Comparing `pyquantimclient-1.0.85.tar` & `PyQuantimClient-1.0.9.tar`

### file list

```diff
@@ -1,22 +1,19 @@
-drwxr-xr-x   0 runner    (1001) docker     (127)        0 2024-04-19 02:49:10.181585 pyquantimclient-1.0.85/
--rw-r--r--   0 runner    (1001) docker     (127)      347 2024-04-19 02:49:10.177585 pyquantimclient-1.0.85/PKG-INFO
-drwxr-xr-x   0 runner    (1001) docker     (127)        0 2024-04-19 02:49:10.177585 pyquantimclient-1.0.85/PyQuantimClient.egg-info/
--rw-r--r--   0 runner    (1001) docker     (127)      347 2024-04-19 02:49:10.000000 pyquantimclient-1.0.85/PyQuantimClient.egg-info/PKG-INFO
--rw-r--r--   0 runner    (1001) docker     (127)      338 2024-04-19 02:49:10.000000 pyquantimclient-1.0.85/PyQuantimClient.egg-info/SOURCES.txt
--rw-r--r--   0 runner    (1001) docker     (127)        1 2024-04-19 02:49:10.000000 pyquantimclient-1.0.85/PyQuantimClient.egg-info/dependency_links.txt
--rw-r--r--   0 runner    (1001) docker     (127)       16 2024-04-19 02:49:10.000000 pyquantimclient-1.0.85/PyQuantimClient.egg-info/top_level.txt
--rw-r--r--   0 runner    (1001) docker     (127)       60 2024-04-19 02:49:01.000000 pyquantimclient-1.0.85/README.md
--rw-r--r--   0 runner    (1001) docker     (127)       38 2024-04-19 02:49:10.181585 pyquantimclient-1.0.85/setup.cfg
--rw-r--r--   0 runner    (1001) docker     (127)      488 2024-04-19 02:49:01.000000 pyquantimclient-1.0.85/setup.py
-drwxr-xr-x   0 runner    (1001) docker     (127)        0 2024-04-19 02:49:10.177585 pyquantimclient-1.0.85/src/
--rw-r--r--   0 runner    (1001) docker     (127)        0 2024-04-19 02:49:01.000000 pyquantimclient-1.0.85/src/__init__.py
--rw-r--r--   0 runner    (1001) docker     (127)     4173 2024-04-19 02:49:01.000000 pyquantimclient-1.0.85/src/api.py
--rw-r--r--   0 runner    (1001) docker     (127)     2168 2024-04-19 02:49:01.000000 pyquantimclient-1.0.85/src/benchmarks.py
--rw-r--r--   0 runner    (1001) docker     (127)     7957 2024-04-19 02:49:01.000000 pyquantimclient-1.0.85/src/bi.py
--rw-r--r--   0 runner    (1001) docker     (127)      725 2024-04-19 02:49:01.000000 pyquantimclient-1.0.85/src/data.py
--rw-r--r--   0 runner    (1001) docker     (127)     1820 2024-04-19 02:49:01.000000 pyquantimclient-1.0.85/src/energy.py
--rw-r--r--   0 runner    (1001) docker     (127)     1088 2024-04-19 02:49:01.000000 pyquantimclient-1.0.85/src/performance.py
--rw-r--r--   0 runner    (1001) docker     (127)     9596 2024-04-19 02:49:01.000000 pyquantimclient-1.0.85/src/portfolios.py
--rw-r--r--   0 runner    (1001) docker     (127)    19944 2024-04-19 02:49:01.000000 pyquantimclient-1.0.85/src/preprocess_co.py
--rw-r--r--   0 runner    (1001) docker     (127)     8548 2024-04-19 02:49:01.000000 pyquantimclient-1.0.85/src/risk.py
--rw-r--r--   0 runner    (1001) docker     (127)      479 2024-04-19 02:49:01.000000 pyquantimclient-1.0.85/src/utils.py
...
### Comparing `pyquantimclient-1.0.85/src/api.py` & `PyQuantimClient-1.0.9/src/api.py`
...
### Comparing `pyquantimclient-1.0.85/src/benchmarks.py` & `PyQuantimClient-1.0.9/src/benchmarks.py`
...
### Comparing `pyquantimclient-1.0.85/src/data.py` & `PyQuantimClient-1.0.9/src/data.py`
...
### Comparing `pyquantimclient-1.0.85/src/energy.py` & `PyQuantimClient-1.0.9/src/energy.py`
