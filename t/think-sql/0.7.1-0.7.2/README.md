# Comparing `tmp/think_sql-0.7.1.tar.gz` & `tmp/think_sql-0.7.2.tar.gz`
...
+gzip compressed data, was "think_sql-0.7.2.tar", max compression
```

## Comparing `think_sql-0.7.1.tar` & `think_sql-0.7.2.tar`
...
+-rw-r--r--   0        0        0     1381 2024-04-18 09:31:38.761647 think_sql-0.7.2/pyproject.toml
+-rw-r--r--   0        0        0    16301 2024-04-16 02:14:07.551128 think_sql-0.7.2/README.md
+-rw-r--r--   0        0        0     1139 2024-04-18 06:57:07.348401 think_sql-0.7.2/think_sql/__init__.py
+-rw-r--r--   0        0        0       70 2024-04-15 09:26:44.219328 think_sql-0.7.2/think_sql/dm/__init__.py
+-rw-r--r--   0        0        0     4689 2024-04-18 06:56:42.003796 think_sql-0.7.2/think_sql/dm/db.py
+-rw-r--r--   0        0        0    28685 2024-04-18 09:30:35.416848 think_sql-0.7.2/think_sql/dm/table.py
+-rw-r--r--   0        0        0     5632 2024-04-18 09:26:32.736723 think_sql-0.7.2/think_sql/dm/util.py
+-rw-r--r--   0        0        0       76 2024-04-15 05:46:17.205661 think_sql-0.7.2/think_sql/mysql/__init__.py
+-rw-r--r--   0        0        0     4027 2024-04-16 02:15:08.168259 think_sql-0.7.2/think_sql/mysql/db.py
+-rw-r--r--   0        0        0     2837 2024-01-19 04:32:29.868664 think_sql-0.7.2/think_sql/mysql/parse.py
+-rw-r--r--   0        0        0    27967 2024-04-15 05:46:51.928111 think_sql-0.7.2/think_sql/mysql/sql_helper.py
+-rw-r--r--   0        0        0    25448 2024-04-16 00:54:40.974556 think_sql-0.7.2/think_sql/mysql/table.py
+-rw-r--r--   0        0        0     3475 2024-04-15 06:24:27.467941 think_sql-0.7.2/think_sql/mysql/util.py
+-rw-r--r--   0        0        0        0 2024-04-11 01:32:11.713368 think_sql-0.7.2/think_sql/tool/__init__.py
+-rw-r--r--   0        0        0     3923 2024-04-16 00:57:11.045987 think_sql-0.7.2/think_sql/tool/base.py
+-rw-r--r--   0        0        0     2360 2024-04-15 05:48:22.966562 think_sql-0.7.2/think_sql/tool/cache.py
+-rw-r--r--   0        0        0     3713 2024-04-16 01:02:24.858779 think_sql-0.7.2/think_sql/tool/interface.py
+-rw-r--r--   0        0        0     3379 2024-04-16 02:14:57.886205 think_sql-0.7.2/think_sql/tool/util.py
+-rw-r--r--   0        0        0    17944 1970-01-01 00:00:00.000000 think_sql-0.7.2/setup.py
+-rw-r--r--   0        0        0    17160 1970-01-01 00:00:00.000000 think_sql-0.7.2/PKG-INFO
```

### Comparing `think_sql-0.7.1/pyproject.toml` & `think_sql-0.7.2/pyproject.toml`
...
### Comparing `think_sql-0.7.1/README.md` & `think_sql-0.7.2/README.md`

 * *Files identical despite different names*

### Comparing `think_sql-0.7.1/think_sql/__init__.py` & `think_sql-0.7.2/think_sql/__init__.py`

 * *Files identical despite different names*

### Comparing `think_sql-0.7.1/think_sql/dm/db.py` & `think_sql-0.7.2/think_sql/dm/db.py`

 * *Files identical despite different names*

### Comparing `think_sql-0.7.1/think_sql/dm/table.py` & `think_sql-0.7.2/think_sql/dm/table.py`
...
### Comparing `think_sql-0.7.1/think_sql/dm/util.py` & `think_sql-0.7.2/think_sql/dm/util.py`
...
### Comparing `think_sql-0.7.1/think_sql/mysql/db.py` & `think_sql-0.7.2/think_sql/mysql/db.py`

 * *Files identical despite different names*

### Comparing `think_sql-0.7.1/think_sql/mysql/parse.py` & `think_sql-0.7.2/think_sql/mysql/parse.py`

 * *Files identical despite different names*

### Comparing `think_sql-0.7.1/think_sql/mysql/sql_helper.py` & `think_sql-0.7.2/think_sql/mysql/sql_helper.py`

 * *Files identical despite different names*

### Comparing `think_sql-0.7.1/think_sql/mysql/table.py` & `think_sql-0.7.2/think_sql/mysql/table.py`

 * *Files identical despite different names*

### Comparing `think_sql-0.7.1/think_sql/mysql/util.py` & `think_sql-0.7.2/think_sql/mysql/util.py`

 * *Files identical despite different names*

### Comparing `think_sql-0.7.1/think_sql/tool/base.py` & `think_sql-0.7.2/think_sql/tool/base.py`

 * *Files identical despite different names*

### Comparing `think_sql-0.7.1/think_sql/tool/cache.py` & `think_sql-0.7.2/think_sql/tool/cache.py`

 * *Files identical despite different names*

### Comparing `think_sql-0.7.1/think_sql/tool/interface.py` & `think_sql-0.7.2/think_sql/tool/interface.py`

 * *Files identical despite different names*

### Comparing `think_sql-0.7.1/think_sql/tool/util.py` & `think_sql-0.7.2/think_sql/tool/util.py`

 * *Files identical despite different names*

### Comparing `think_sql-0.7.1/setup.py` & `think_sql-0.7.2/setup.py`
...
### Comparing `think_sql-0.7.1/PKG-INFO` & `think_sql-0.7.2/PKG-INFO`
