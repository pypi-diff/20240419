# Comparing `tmp/tagreader-5.2.1.tar.gz` & `tmp/tagreader-5.3.0.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "tagreader-5.2.1.tar", max compression
+gzip compressed data, was "tagreader-5.3.0.tar", max compression
```

## Comparing `tagreader-5.2.1.tar` & `tagreader-5.3.0.tar`

### file list

```diff
@@ -1,11 +1,11 @@
--rw-r--r--   0        0        0     1064 2023-09-28 09:58:51.819492 tagreader-5.2.1/LICENSE
--rw-r--r--   0        0        0     2244 2023-12-06 12:21:15.791260 tagreader-5.2.1/README.md
--rw-r--r--   0        0        0     1751 2024-03-18 10:25:36.006093 tagreader-5.2.1/pyproject.toml
--rw-r--r--   0        0        0      304 2023-09-28 09:58:51.832119 tagreader-5.2.1/tagreader/__init__.py
--rw-r--r--   0        0        0      282 2023-09-28 09:58:51.832328 tagreader-5.2.1/tagreader/__version__.py
--rw-r--r--   0        0        0    11781 2023-09-28 09:58:51.832636 tagreader-5.2.1/tagreader/cache.py
--rw-r--r--   0        0        0    22160 2024-03-06 13:23:35.437548 tagreader-5.2.1/tagreader/clients.py
--rw-r--r--   0        0        0      198 2023-09-28 09:58:51.833080 tagreader-5.2.1/tagreader/logger.py
--rw-r--r--   0        0        0     8933 2024-03-06 13:23:35.437884 tagreader-5.2.1/tagreader/utils.py
--rw-r--r--   0        0        0    35548 2024-03-18 10:05:31.657755 tagreader-5.2.1/tagreader/web_handlers.py
--rw-r--r--   0        0        0     4056 1970-01-01 00:00:00.000000 tagreader-5.2.1/PKG-INFO
...
### Comparing `tagreader-5.2.1/README.md` & `tagreader-5.3.0/README.md`
...
### Comparing `tagreader-5.2.1/pyproject.toml` & `tagreader-5.3.0/pyproject.toml`
...
### Comparing `tagreader-5.2.1/tagreader/web_handlers.py` & `tagreader-5.3.0/tagreader/web_handlers.py`
...
### Comparing `tagreader-5.2.1/PKG-INFO` & `tagreader-5.3.0/PKG-INFO`
...
-Requires-Dist: msal-bearer (>=0.1.0,<0.2.0)
