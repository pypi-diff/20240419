# Comparing `tmp/jobbergate_cli-5.0.0a1.tar.gz` & `tmp/jobbergate_cli-5.0.0a2.tar.gz`
...
### Comparing `jobbergate_cli-5.0.0a1/PKG-INFO` & `jobbergate_cli-5.0.0a2/PKG-INFO`
