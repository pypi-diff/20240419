# Comparing `tmp/bitcoin_qrreader-0.8.4.tar.gz` & `tmp/bitcoin_qrreader-0.8.5.tar.gz`
...
### Comparing `bitcoin_qrreader-0.8.4/bitcoin_qrreader/ur/LICENSE` & `bitcoin_qrreader-0.8.5/bitcoin_qrreader/ur/LICENSE`
