# Comparing `tmp/bucketed_scene_flow_eval-2.0.3.tar.gz` & `tmp/bucketed_scene_flow_eval-2.0.4.tar.gz`
...
### Comparing `bucketed_scene_flow_eval-2.0.3/tests/setup.sh` & `bucketed_scene_flow_eval-2.0.4/tests/setup.sh`
