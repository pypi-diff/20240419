# Comparing `tmp/pkg_newfinalcustom_pipeline_staging_final-0.0.4.tar.gz` & `tmp/pkg_newfinalcustom_pipeline_staging_final-0.0.5.tar.gz`
...
## Comparing `pkg_newfinalcustom_pipeline_staging_final-0.0.4.tar` & `pkg_newfinalcustom_pipeline_staging_final-0.0.5.tar`
...
### Comparing `pkg_newfinalcustom_pipeline_staging_final-0.0.4/PKG-INFO` & `pkg_newfinalcustom_pipeline_staging_final-0.0.5/PKG-INFO`
...
### Comparing `pkg_newfinalcustom_pipeline_staging_final-0.0.4/pipeline_staging_properties_pkg/pipeline_staging_properties.py` & `pkg_newfinalcustom_pipeline_staging_final-0.0.5/pipeline_staging_properties_pkg/pipeline_staging_properties.py`
...
### Comparing `pkg_newfinalcustom_pipeline_staging_final-0.0.4/pkg_newfinalcustom_pipeline_staging_final.egg-info/PKG-INFO` & `pkg_newfinalcustom_pipeline_staging_final-0.0.5/pkg_newfinalcustom_pipeline_staging_final.egg-info/PKG-INFO`
...
### Comparing `pkg_newfinalcustom_pipeline_staging_final-0.0.4/setup.py` & `pkg_newfinalcustom_pipeline_staging_final-0.0.5/setup.py`
