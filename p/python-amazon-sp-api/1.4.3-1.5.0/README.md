# Comparing `tmp/python-amazon-sp-api-1.4.3.tar.gz` & `tmp/python-amazon-sp-api-1.5.0.tar.gz`
...
### Comparing `python-amazon-sp-api-1.4.3/README.md` & `python-amazon-sp-api-1.5.0/README.md`
...
### Comparing `python-amazon-sp-api-1.4.3/sp_api/api/application_management/application_management.py` & `python-amazon-sp-api-1.5.0/sp_api/api/application_management/application_management.py`
...
### Comparing `python-amazon-sp-api-1.4.3/sp_api/api/product_fees/product_fees.py` & `python-amazon-sp-api-1.5.0/sp_api/api/product_fees/product_fees.py`
...
### Comparing `python-amazon-sp-api-1.4.3/sp_api/base/marketplaces.py` & `python-amazon-sp-api-1.5.0/sp_api/base/marketplaces.py`

 * *Files identical despite different names*

### Comparing `python-amazon-sp-api-1.4.3/sp_api/base/notifications.py` & `python-amazon-sp-api-1.5.0/sp_api/base/notifications.py`

 * *Files identical despite different names*

### Comparing `python-amazon-sp-api-1.4.3/sp_api/base/reportTypes.py` & `python-amazon-sp-api-1.5.0/sp_api/base/reportTypes.py`

 * *Files identical despite different names*

### Comparing `python-amazon-sp-api-1.4.3/sp_api/util/key_maker.py` & `python-amazon-sp-api-1.5.0/sp_api/util/key_maker.py`

 * *Files identical despite different names*

### Comparing `python-amazon-sp-api-1.4.3/sp_api/util/load_all_pages.py` & `python-amazon-sp-api-1.5.0/sp_api/util/load_all_pages.py`

 * *Files identical despite different names*

### Comparing `python-amazon-sp-api-1.4.3/sp_api/util/load_date_bound.py` & `python-amazon-sp-api-1.5.0/sp_api/util/load_date_bound.py`

 * *Files identical despite different names*

### Comparing `python-amazon-sp-api-1.4.3/sp_api/util/retry.py` & `python-amazon-sp-api-1.5.0/sp_api/util/retry.py`

 * *Files identical despite different names*

### Comparing `python-amazon-sp-api-1.4.3/tests/api/finances/test_finances.py` & `python-amazon-sp-api-1.5.0/tests/api/finances/test_finances.py`

 * *Files identical despite different names*

### Comparing `python-amazon-sp-api-1.4.3/tests/api/notifications/test_notifications.py` & `python-amazon-sp-api-1.5.0/tests/api/notifications/test_notifications.py`

 * *Files identical despite different names*

### Comparing `python-amazon-sp-api-1.4.3/tests/api/orders/test_orders.py` & `python-amazon-sp-api-1.5.0/tests/api/orders/test_orders.py`

 * *Files identical despite different names*

### Comparing `python-amazon-sp-api-1.4.3/tests/api/product_fees/product_fees.py` & `python-amazon-sp-api-1.5.0/tests/api/product_fees/product_fees.py`

 * *Files identical despite different names*

### Comparing `python-amazon-sp-api-1.4.3/tests/api/reports/test_reports.py` & `python-amazon-sp-api-1.5.0/tests/api/reports/test_reports.py`

 * *Files identical despite different names*

### Comparing `python-amazon-sp-api-1.4.3/tests/client/test_auth.py` & `python-amazon-sp-api-1.5.0/tests/client/test_auth.py`

 * *Files identical despite different names*

### Comparing `python-amazon-sp-api-1.4.3/tests/client/test_base.py` & `python-amazon-sp-api-1.5.0/tests/client/test_base.py`

 * *Files identical despite different names*

### Comparing `python-amazon-sp-api-1.4.3/tests/client/test_credential_provider.py` & `python-amazon-sp-api-1.5.0/tests/client/test_credential_provider.py`

 * *Files identical despite different names*

### Comparing `python-amazon-sp-api-1.4.3/tests/client/test_helpers.py` & `python-amazon-sp-api-1.5.0/tests/client/test_helpers.py`
