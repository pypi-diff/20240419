# Comparing `tmp/whyis_activitystreams-0.1.1.tar.gz` & `tmp/whyis_activitystreams-0.1.2.tar.gz`
...
### Comparing `whyis_activitystreams-0.1.1/LICENSE` & `whyis_activitystreams-0.1.2/LICENSE`
