# Comparing `tmp/simple_media_manager-0.1.1.tar.gz` & `tmp/simple_media_manager-0.1.2.tar.gz`
...
### Comparing `simple_media_manager-0.1.1/pyproject.toml` & `simple_media_manager-0.1.2/pyproject.toml`
