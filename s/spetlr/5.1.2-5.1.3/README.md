# Comparing `tmp/spetlr-5.1.2.tar.gz` & `tmp/spetlr-5.1.3.tar.gz`
...
### Comparing `spetlr-5.1.2/LICENSE` & `spetlr-5.1.3/LICENSE`

 * *Files identical despite different names*

### Comparing `spetlr-5.1.2/PKG-INFO` & `spetlr-5.1.3/PKG-INFO`
...
### Comparing `spetlr-5.1.2/README.md` & `spetlr-5.1.3/README.md`

 * *Files identical despite different names*

### Comparing `spetlr-5.1.2/setup.cfg` & `spetlr-5.1.3/setup.cfg`

 * *Files identical despite different names*

### Comparing `spetlr-5.1.2/src/spetlr/azure_log_analytics/azure_log_analytics_handle.py` & `spetlr-5.1.3/src/spetlr/azure_log_analytics/azure_log_analytics_handle.py`

 * *Files identical despite different names*

### Comparing `spetlr-5.1.2/src/spetlr/cache/CachedLoader.py` & `spetlr-5.1.3/src/spetlr/cache/CachedLoader.py`

 * *Files identical despite different names*

### Comparing `spetlr-5.1.2/src/spetlr/cache/CachedLoaderParameters.py` & `spetlr-5.1.3/src/spetlr/cache/CachedLoaderParameters.py`

 * *Files identical despite different names*

### Comparing `spetlr-5.1.2/src/spetlr/configurator/_cli/ConfiguratorCli.py` & `spetlr-5.1.3/src/spetlr/configurator/_cli/ConfiguratorCli.py`

 * *Files identical despite different names*

### Comparing `spetlr-5.1.2/src/spetlr/configurator/_cli/generate_keys_file.py` & `spetlr-5.1.3/src/spetlr/configurator/_cli/generate_keys_file.py`

 * *Files identical despite different names*

### Comparing `spetlr-5.1.2/src/spetlr/configurator/configurator.py` & `spetlr-5.1.3/src/spetlr/configurator/configurator.py`

 * *Files identical despite different names*

### Comparing `spetlr-5.1.2/src/spetlr/configurator/sql/StatementBlocks.py` & `spetlr-5.1.3/src/spetlr/configurator/sql/StatementBlocks.py`

 * *Files identical despite different names*

### Comparing `spetlr-5.1.2/src/spetlr/configurator/sql/comments.py` & `spetlr-5.1.3/src/spetlr/configurator/sql/comments.py`

 * *Files identical despite different names*

### Comparing `spetlr-5.1.2/src/spetlr/configurator/sql/create.py` & `spetlr-5.1.3/src/spetlr/configurator/sql/create.py`

 * *Files identical despite different names*

### Comparing `spetlr-5.1.2/src/spetlr/configurator/sql/db.py` & `spetlr-5.1.3/src/spetlr/configurator/sql/db.py`

 * *Files identical despite different names*

### Comparing `spetlr-5.1.2/src/spetlr/configurator/sql/init_sqlparse.py` & `spetlr-5.1.3/src/spetlr/configurator/sql/init_sqlparse.py`

 * *Files identical despite different names*

### Comparing `spetlr-5.1.2/src/spetlr/configurator/sql/parse_sql.py` & `spetlr-5.1.3/src/spetlr/configurator/sql/parse_sql.py`

 * *Files identical despite different names*

### Comparing `spetlr-5.1.2/src/spetlr/configurator/sql/substructures.py` & `spetlr-5.1.3/src/spetlr/configurator/sql/substructures.py`

 * *Files identical despite different names*

### Comparing `spetlr-5.1.2/src/spetlr/configurator/sql/table.py` & `spetlr-5.1.3/src/spetlr/configurator/sql/table.py`

 * *Files identical despite different names*

### Comparing `spetlr-5.1.2/src/spetlr/configurator/sql/view.py` & `spetlr-5.1.3/src/spetlr/configurator/sql/view.py`

 * *Files identical despite different names*

### Comparing `spetlr-5.1.2/src/spetlr/cosmos/cosmos.py` & `spetlr-5.1.3/src/spetlr/cosmos/cosmos.py`

 * *Files identical despite different names*

### Comparing `spetlr-5.1.2/src/spetlr/cosmos/cosmos_base_server.py` & `spetlr-5.1.3/src/spetlr/cosmos/cosmos_base_server.py`

 * *Files identical despite different names*

### Comparing `spetlr-5.1.2/src/spetlr/cosmos/cosmos_handle.py` & `spetlr-5.1.3/src/spetlr/cosmos/cosmos_handle.py`

 * *Files identical despite different names*

### Comparing `spetlr-5.1.2/src/spetlr/db_auto.py` & `spetlr-5.1.3/src/spetlr/db_auto.py`

 * *Files identical despite different names*

### Comparing `spetlr-5.1.2/src/spetlr/delta/db_handle.py` & `spetlr-5.1.3/src/spetlr/delta/db_handle.py`

 * *Files identical despite different names*

### Comparing `spetlr-5.1.2/src/spetlr/delta/delta_handle.py` & `spetlr-5.1.3/src/spetlr/delta/delta_handle.py`

 * *Files identical despite different names*

### Comparing `spetlr-5.1.2/src/spetlr/deltaspec/DeltaDatabaseSpec.py` & `spetlr-5.1.3/src/spetlr/deltaspec/DeltaDatabaseSpec.py`

 * *Files identical despite different names*

### Comparing `spetlr-5.1.2/src/spetlr/deltaspec/DeltaTableSpec.py` & `spetlr-5.1.3/src/spetlr/deltaspec/DeltaTableSpec.py`

 * *Files identical despite different names*

### Comparing `spetlr-5.1.2/src/spetlr/deltaspec/DeltaTableSpecBase.py` & `spetlr-5.1.3/src/spetlr/deltaspec/DeltaTableSpecBase.py`

 * *Files identical despite different names*

### Comparing `spetlr-5.1.2/src/spetlr/deltaspec/DeltaTableSpecDifference.py` & `spetlr-5.1.3/src/spetlr/deltaspec/DeltaTableSpecDifference.py`

 * *Files identical despite different names*

### Comparing `spetlr-5.1.2/src/spetlr/deltaspec/__init__.py` & `spetlr-5.1.3/src/spetlr/deltaspec/__init__.py`

 * *Files identical despite different names*

### Comparing `spetlr-5.1.2/src/spetlr/deltaspec/exceptions.py` & `spetlr-5.1.3/src/spetlr/deltaspec/exceptions.py`

 * *Files identical despite different names*

### Comparing `spetlr-5.1.2/src/spetlr/deltaspec/helpers.py` & `spetlr-5.1.3/src/spetlr/deltaspec/helpers.py`

 * *Files identical despite different names*

### Comparing `spetlr-5.1.2/src/spetlr/eh/EventHubCapture.py` & `spetlr-5.1.3/src/spetlr/eh/EventHubCapture.py`

 * *Files identical despite different names*

### Comparing `spetlr-5.1.2/src/spetlr/eh/EventHubCaptureExtractor.py` & `spetlr-5.1.3/src/spetlr/eh/EventHubCaptureExtractor.py`

 * *Files identical despite different names*

### Comparing `spetlr-5.1.2/src/spetlr/eh/EventHubJsonPublisher.py` & `spetlr-5.1.3/src/spetlr/eh/EventHubJsonPublisher.py`

 * *Files identical despite different names*

### Comparing `spetlr-5.1.2/src/spetlr/eh/EventHubStream.py` & `spetlr-5.1.3/src/spetlr/eh/EventHubStream.py`

 * *Files identical despite different names*

### Comparing `spetlr-5.1.2/src/spetlr/eh/PartitionSpec.py` & `spetlr-5.1.3/src/spetlr/eh/PartitionSpec.py`

 * *Files identical despite different names*

### Comparing `spetlr-5.1.2/src/spetlr/entry_points/generalized_task_entry_point.py` & `spetlr-5.1.3/src/spetlr/entry_points/generalized_task_entry_point.py`

 * *Files identical despite different names*

### Comparing `spetlr-5.1.2/src/spetlr/entry_points/task_entry_point.py` & `spetlr-5.1.3/src/spetlr/entry_points/task_entry_point.py`

 * *Files identical despite different names*

### Comparing `spetlr-5.1.2/src/spetlr/etl/extractor.py` & `spetlr-5.1.3/src/spetlr/etl/extractor.py`

 * *Files identical despite different names*

### Comparing `spetlr-5.1.2/src/spetlr/etl/extractors/__init__.py` & `spetlr-5.1.3/src/spetlr/etl/extractors/__init__.py`

 * *Files identical despite different names*

### Comparing `spetlr-5.1.2/src/spetlr/etl/extractors/check_schema_extractor.py` & `spetlr-5.1.3/src/spetlr/etl/extractors/check_schema_extractor.py`

 * *Files identical despite different names*

### Comparing `spetlr-5.1.2/src/spetlr/etl/extractors/incremental_extractor.py` & `spetlr-5.1.3/src/spetlr/etl/extractors/incremental_extractor.py`

 * *Files identical despite different names*

### Comparing `spetlr-5.1.2/src/spetlr/etl/extractors/lazy_extractor.py` & `spetlr-5.1.3/src/spetlr/etl/extractors/lazy_extractor.py`

 * *Files identical despite different names*

### Comparing `spetlr-5.1.2/src/spetlr/etl/extractors/lazy_simple_extractor.py` & `spetlr-5.1.3/src/spetlr/etl/extractors/lazy_simple_extractor.py`

 * *Files identical despite different names*

### Comparing `spetlr-5.1.2/src/spetlr/etl/extractors/schema_extractor.py` & `spetlr-5.1.3/src/spetlr/etl/extractors/schema_extractor.py`

 * *Files identical despite different names*

### Comparing `spetlr-5.1.2/src/spetlr/etl/loader.py` & `spetlr-5.1.3/src/spetlr/etl/loader.py`

 * *Files identical despite different names*

### Comparing `spetlr-5.1.2/src/spetlr/etl/loaders/DeleteDataLoader.py` & `spetlr-5.1.3/src/spetlr/etl/loaders/DeleteDataLoader.py`

 * *Files identical despite different names*

### Comparing `spetlr-5.1.2/src/spetlr/etl/loaders/UpsertLoader.py` & `spetlr-5.1.3/src/spetlr/etl/loaders/UpsertLoader.py`

 * *Files identical despite different names*

### Comparing `spetlr-5.1.2/src/spetlr/etl/loaders/scd2_loader.py` & `spetlr-5.1.3/src/spetlr/etl/loaders/scd2_loader.py`

 * *Files identical despite different names*

### Comparing `spetlr-5.1.2/src/spetlr/etl/loaders/simple_loader.py` & `spetlr-5.1.3/src/spetlr/etl/loaders/simple_loader.py`

 * *Files identical despite different names*

### Comparing `spetlr-5.1.2/src/spetlr/etl/loaders/stream_loader.py` & `spetlr-5.1.3/src/spetlr/etl/loaders/stream_loader.py`

 * *Files identical despite different names*

### Comparing `spetlr-5.1.2/src/spetlr/etl/loaders/upsert_loader_streaming.py` & `spetlr-5.1.3/src/spetlr/etl/loaders/upsert_loader_streaming.py`

 * *Files identical despite different names*

### Comparing `spetlr-5.1.2/src/spetlr/etl/log/log_orchestrator.py` & `spetlr-5.1.3/src/spetlr/etl/log/log_orchestrator.py`

 * *Files identical despite different names*

### Comparing `spetlr-5.1.2/src/spetlr/etl/log/log_transformer.py` & `spetlr-5.1.3/src/spetlr/etl/log/log_transformer.py`

 * *Files identical despite different names*

### Comparing `spetlr-5.1.2/src/spetlr/etl/log/log_transformers/count_log_transformer.py` & `spetlr-5.1.3/src/spetlr/etl/log/log_transformers/count_log_transformer.py`

 * *Files identical despite different names*

### Comparing `spetlr-5.1.2/src/spetlr/etl/log/log_transformers/null_log_transformer.py` & `spetlr-5.1.3/src/spetlr/etl/log/log_transformers/null_log_transformer.py`

 * *Files identical despite different names*

### Comparing `spetlr-5.1.2/src/spetlr/etl/orchestrator.py` & `spetlr-5.1.3/src/spetlr/etl/orchestrator.py`

 * *Files identical despite different names*

### Comparing `spetlr-5.1.2/src/spetlr/etl/transformer.py` & `spetlr-5.1.3/src/spetlr/etl/transformer.py`

 * *Files identical despite different names*

### Comparing `spetlr-5.1.2/src/spetlr/etl/transformers/SimpleSqlTransformer.py` & `spetlr-5.1.3/src/spetlr/etl/transformers/SimpleSqlTransformer.py`

 * *Files identical despite different names*

### Comparing `spetlr-5.1.2/src/spetlr/etl/transformers/__init__.py` & `spetlr-5.1.3/src/spetlr/etl/transformers/__init__.py`

 * *Files identical despite different names*

### Comparing `spetlr-5.1.2/src/spetlr/etl/transformers/clean_column_names_transformer.py` & `spetlr-5.1.3/src/spetlr/etl/transformers/clean_column_names_transformer.py`

 * *Files identical despite different names*

### Comparing `spetlr-5.1.2/src/spetlr/etl/transformers/country_to_alphacode_transformer.py` & `spetlr-5.1.3/src/spetlr/etl/transformers/country_to_alphacode_transformer.py`

 * *Files identical despite different names*

### Comparing `spetlr-5.1.2/src/spetlr/etl/transformers/data_change_capture_transformer.py` & `spetlr-5.1.3/src/spetlr/etl/transformers/data_change_capture_transformer.py`

 * *Files identical despite different names*

### Comparing `spetlr-5.1.2/src/spetlr/etl/transformers/dropColumnsTransformer.py` & `spetlr-5.1.3/src/spetlr/etl/transformers/dropColumnsTransformer.py`

 * *Files identical despite different names*

### Comparing `spetlr-5.1.2/src/spetlr/etl/transformers/drop_oldest_duplicate_transformer.py` & `spetlr-5.1.3/src/spetlr/etl/transformers/drop_oldest_duplicate_transformer.py`

 * *Files identical despite different names*

### Comparing `spetlr-5.1.2/src/spetlr/etl/transformers/fuzzy_select.py` & `spetlr-5.1.3/src/spetlr/etl/transformers/fuzzy_select.py`

 * *Files identical despite different names*

### Comparing `spetlr-5.1.2/src/spetlr/etl/transformers/generate_md5_column_transformer.py` & `spetlr-5.1.3/src/spetlr/etl/transformers/generate_md5_column_transformer.py`

 * *Files identical despite different names*

### Comparing `spetlr-5.1.2/src/spetlr/etl/transformers/join_dataframes_transformer.py` & `spetlr-5.1.3/src/spetlr/etl/transformers/join_dataframes_transformer.py`

 * *Files identical despite different names*

### Comparing `spetlr-5.1.2/src/spetlr/etl/transformers/selectColumnsTransformer.py` & `spetlr-5.1.3/src/spetlr/etl/transformers/selectColumnsTransformer.py`

 * *Files identical despite different names*

### Comparing `spetlr-5.1.2/src/spetlr/etl/transformers/select_and_cast_columns_transformer.py` & `spetlr-5.1.3/src/spetlr/etl/transformers/select_and_cast_columns_transformer.py`

 * *Files identical despite different names*

### Comparing `spetlr-5.1.2/src/spetlr/etl/transformers/simple_dataframe_filter_transformer.py` & `spetlr-5.1.3/src/spetlr/etl/transformers/simple_dataframe_filter_transformer.py`

 * *Files identical despite different names*

### Comparing `spetlr-5.1.2/src/spetlr/etl/transformers/simple_sql_transformer.py` & `spetlr-5.1.3/src/spetlr/etl/transformers/simple_sql_transformer.py`

 * *Files identical despite different names*

### Comparing `spetlr-5.1.2/src/spetlr/etl/transformers/timezone_transformer.py` & `spetlr-5.1.3/src/spetlr/etl/transformers/timezone_transformer.py`

 * *Files identical despite different names*

### Comparing `spetlr-5.1.2/src/spetlr/etl/transformers/union_transformer.py` & `spetlr-5.1.3/src/spetlr/etl/transformers/union_transformer.py`

 * *Files identical despite different names*

### Comparing `spetlr-5.1.2/src/spetlr/etl/transformers/validfromto_transformer.py` & `spetlr-5.1.3/src/spetlr/etl/transformers/validfromto_transformer.py`

 * *Files identical despite different names*

### Comparing `spetlr-5.1.2/src/spetlr/exceptions/__init__.py` & `spetlr-5.1.3/src/spetlr/exceptions/__init__.py`

 * *Files identical despite different names*

### Comparing `spetlr-5.1.2/src/spetlr/extractors/eventhub_stream_extractor.py` & `spetlr-5.1.3/src/spetlr/extractors/eventhub_stream_extractor.py`

 * *Files identical despite different names*

### Comparing `spetlr-5.1.2/src/spetlr/filehandle/file_handle.py` & `spetlr-5.1.3/src/spetlr/filehandle/file_handle.py`

 * *Files identical despite different names*

### Comparing `spetlr-5.1.2/src/spetlr/formatting/git_hooks.py` & `spetlr-5.1.3/src/spetlr/formatting/git_hooks.py`

 * *Files identical despite different names*

### Comparing `spetlr-5.1.2/src/spetlr/functions.py` & `spetlr-5.1.3/src/spetlr/functions.py`

 * *Files identical despite different names*

### Comparing `spetlr-5.1.2/src/spetlr/mount/main.py` & `spetlr-5.1.3/src/spetlr/mount/main.py`

 * *Files identical despite different names*

### Comparing `spetlr-5.1.2/src/spetlr/orchestrators/eh2bronze/EhToDeltaBronzeOrchestrator.py` & `spetlr-5.1.3/src/spetlr/orchestrators/eh2bronze/EhToDeltaBronzeOrchestrator.py`

 * *Files identical despite different names*

### Comparing `spetlr-5.1.2/src/spetlr/orchestrators/eh2bronze/EhToDeltaBronzeTransformer.py` & `spetlr-5.1.3/src/spetlr/orchestrators/eh2bronze/EhToDeltaBronzeTransformer.py`

 * *Files identical despite different names*

### Comparing `spetlr-5.1.2/src/spetlr/orchestrators/eh2silver/EhToDeltaSilverOrchestrator.py` & `spetlr-5.1.3/src/spetlr/orchestrators/eh2silver/EhToDeltaSilverOrchestrator.py`

 * *Files identical despite different names*

### Comparing `spetlr-5.1.2/src/spetlr/orchestrators/ehjson2delta/EhJsonToDeltaExtractor.py` & `spetlr-5.1.3/src/spetlr/orchestrators/ehjson2delta/EhJsonToDeltaExtractor.py`

 * *Files identical despite different names*

### Comparing `spetlr-5.1.2/src/spetlr/orchestrators/ehjson2delta/EhJsonToDeltaOrchestrator.py` & `spetlr-5.1.3/src/spetlr/orchestrators/ehjson2delta/EhJsonToDeltaOrchestrator.py`

 * *Files identical despite different names*

### Comparing `spetlr-5.1.2/src/spetlr/orchestrators/ehjson2delta/EhJsonToDeltaTransformer.py` & `spetlr-5.1.3/src/spetlr/orchestrators/ehjson2delta/EhJsonToDeltaTransformer.py`

 * *Files identical despite different names*

### Comparing `spetlr-5.1.2/src/spetlr/power_bi/PowerBi.py` & `spetlr-5.1.3/src/spetlr/power_bi/PowerBi.py`

 * *Files identical despite different names*

### Comparing `spetlr-5.1.2/src/spetlr/reporting/JobReflection.py` & `spetlr-5.1.3/src/spetlr/reporting/JobReflection.py`

 * *Files identical despite different names*

### Comparing `spetlr-5.1.2/src/spetlr/reporting/SlackNotifier.py` & `spetlr-5.1.3/src/spetlr/reporting/SlackNotifier.py`

 * *Files identical despite different names*

### Comparing `spetlr-5.1.2/src/spetlr/schema_manager/schema_manager.py` & `spetlr-5.1.3/src/spetlr/schema_manager/schema_manager.py`

 * *Files identical despite different names*

### Comparing `spetlr-5.1.2/src/spetlr/schema_manager/spark_schema.py` & `spetlr-5.1.3/src/spetlr/schema_manager/spark_schema.py`

 * *Files identical despite different names*

### Comparing `spetlr-5.1.2/src/spetlr/spark.py` & `spetlr-5.1.3/src/spetlr/spark.py`

 * *Files identical despite different names*

### Comparing `spetlr-5.1.2/src/spetlr/sql/CommonBaseServer.py` & `spetlr-5.1.3/src/spetlr/sql/CommonBaseServer.py`

 * *Files identical despite different names*

### Comparing `spetlr-5.1.2/src/spetlr/sql/SqlBaseServer.py` & `spetlr-5.1.3/src/spetlr/sql/SqlBaseServer.py`

 * *Files identical despite different names*

### Comparing `spetlr-5.1.2/src/spetlr/sql/SqlExecutor.py` & `spetlr-5.1.3/src/spetlr/sql/SqlExecutor.py`

 * *Files identical despite different names*

### Comparing `spetlr-5.1.2/src/spetlr/sql/SqlServer.py` & `spetlr-5.1.3/src/spetlr/sql/SqlServer.py`

 * *Files identical despite different names*

### Comparing `spetlr-5.1.2/src/spetlr/sql/sql_handle.py` & `spetlr-5.1.3/src/spetlr/sql/sql_handle.py`

 * *Files identical despite different names*

### Comparing `spetlr-5.1.2/src/spetlr/sqlrepr/sql_types.py` & `spetlr-5.1.3/src/spetlr/sqlrepr/sql_types.py`

 * *Files identical despite different names*

### Comparing `spetlr-5.1.2/src/spetlr/tables/TableHandle.py` & `spetlr-5.1.3/src/spetlr/tables/TableHandle.py`

 * *Files identical despite different names*

### Comparing `spetlr-5.1.2/src/spetlr/testutils/CleanupTestDatabases.py` & `spetlr-5.1.3/src/spetlr/testutils/CleanupTestDatabases.py`

 * *Files identical despite different names*

### Comparing `spetlr-5.1.2/src/spetlr/testutils/stop_test_streams.py` & `spetlr-5.1.3/src/spetlr/testutils/stop_test_streams.py`

 * *Files identical despite different names*

### Comparing `spetlr-5.1.2/src/spetlr/transformations.py` & `spetlr-5.1.3/src/spetlr/transformations.py`

 * *Files identical despite different names*

### Comparing `spetlr-5.1.2/src/spetlr/transformers/__init__.py` & `spetlr-5.1.3/src/spetlr/transformers/__init__.py`

 * *Files identical despite different names*

### Comparing `spetlr-5.1.2/src/spetlr/utils/CheckDfMerge.py` & `spetlr-5.1.3/src/spetlr/utils/CheckDfMerge.py`

 * *Files identical despite different names*

### Comparing `spetlr-5.1.2/src/spetlr/utils/DataframeCreator.py` & `spetlr-5.1.3/src/spetlr/utils/DataframeCreator.py`

 * *Files identical despite different names*

### Comparing `spetlr-5.1.2/src/spetlr/utils/DeleteMismatchedSchemas.py` & `spetlr-5.1.3/src/spetlr/utils/DeleteMismatchedSchemas.py`

 * *Files identical despite different names*

### Comparing `spetlr-5.1.2/src/spetlr/utils/DropOldestDuplicates.py` & `spetlr-5.1.3/src/spetlr/utils/DropOldestDuplicates.py`

 * *Files identical despite different names*

### Comparing `spetlr-5.1.2/src/spetlr/utils/GetMergeStatement.py` & `spetlr-5.1.3/src/spetlr/utils/GetMergeStatement.py`

 * *Files identical despite different names*

### Comparing `spetlr-5.1.2/src/spetlr/utils/Md5HashColumn.py` & `spetlr-5.1.3/src/spetlr/utils/Md5HashColumn.py`

 * *Files identical despite different names*

### Comparing `spetlr-5.1.2/src/spetlr/utils/MockLoader.py` & `spetlr-5.1.3/src/spetlr/utils/MockLoader.py`

 * *Files identical despite different names*

### Comparing `spetlr-5.1.2/src/spetlr/utils/SelectAndCastColumns.py` & `spetlr-5.1.3/src/spetlr/utils/SelectAndCastColumns.py`

 * *Files identical despite different names*

### Comparing `spetlr-5.1.2/src/spetlr/utils/__init__.py` & `spetlr-5.1.3/src/spetlr/utils/__init__.py`

 * *Files identical despite different names*

### Comparing `spetlr-5.1.2/src/spetlr.egg-info/PKG-INFO` & `spetlr-5.1.3/src/spetlr.egg-info/PKG-INFO`
...
### Comparing `spetlr-5.1.2/src/spetlr.egg-info/SOURCES.txt` & `spetlr-5.1.3/src/spetlr.egg-info/SOURCES.txt`

 * *Files identical despite different names*

### Comparing `spetlr-5.1.2/src/spetlr.egg-info/requires.txt` & `spetlr-5.1.3/src/spetlr.egg-info/requires.txt`

 * *Files identical despite different names*

### Comparing `spetlr-5.1.2/tests/cluster/azure_log_analytics/test_azure_log_analytics_handle.py` & `spetlr-5.1.3/tests/cluster/azure_log_analytics/test_azure_log_analytics_handle.py`

 * *Files identical despite different names*

### Comparing `spetlr-5.1.2/tests/cluster/cache/test_cache.py` & `spetlr-5.1.3/tests/cluster/cache/test_cache.py`

 * *Files identical despite different names*

### Comparing `spetlr-5.1.2/tests/cluster/cosmos/test_cosmos.py` & `spetlr-5.1.3/tests/cluster/cosmos/test_cosmos.py`

 * *Files identical despite different names*

### Comparing `spetlr-5.1.2/tests/cluster/delta/deltaspec/test_dbspec.py` & `spetlr-5.1.3/tests/cluster/delta/deltaspec/test_dbspec.py`

 * *Files identical despite different names*

### Comparing `spetlr-5.1.2/tests/cluster/delta/deltaspec/test_tblspec.py` & `spetlr-5.1.3/tests/cluster/delta/deltaspec/test_tblspec.py`

 * *Files identical despite different names*

### Comparing `spetlr-5.1.2/tests/cluster/delta/test_cleanup_databases.py` & `spetlr-5.1.3/tests/cluster/delta/test_cleanup_databases.py`

 * *Files identical despite different names*

### Comparing `spetlr-5.1.2/tests/cluster/delta/test_delta_class.py` & `spetlr-5.1.3/tests/cluster/delta/test_delta_class.py`

 * *Files identical despite different names*

### Comparing `spetlr-5.1.2/tests/cluster/delta/test_delta_stream.py` & `spetlr-5.1.3/tests/cluster/delta/test_delta_stream.py`

 * *Files identical despite different names*

### Comparing `spetlr-5.1.2/tests/cluster/delta/test_filehandle.py` & `spetlr-5.1.3/tests/cluster/delta/test_filehandle.py`

 * *Files identical despite different names*

### Comparing `spetlr-5.1.2/tests/cluster/delta/test_sparkexecutor.py` & `spetlr-5.1.3/tests/cluster/delta/test_sparkexecutor.py`

 * *Files identical despite different names*

### Comparing `spetlr-5.1.2/tests/cluster/eh/test_eh_json_orchestrator.py` & `spetlr-5.1.3/tests/cluster/eh/test_eh_json_orchestrator.py`

 * *Files identical despite different names*

### Comparing `spetlr-5.1.2/tests/cluster/eh/test_eh_json_transformer.py` & `spetlr-5.1.3/tests/cluster/eh/test_eh_json_transformer.py`

 * *Files identical despite different names*

### Comparing `spetlr-5.1.2/tests/cluster/eh/test_eh_saving.py` & `spetlr-5.1.3/tests/cluster/eh/test_eh_saving.py`

 * *Files identical despite different names*

### Comparing `spetlr-5.1.2/tests/cluster/etl/test_checkschemaextractor.py` & `spetlr-5.1.3/tests/cluster/etl/test_checkschemaextractor.py`

 * *Files identical despite different names*

### Comparing `spetlr-5.1.2/tests/cluster/etl/test_delete_data_loader.py` & `spetlr-5.1.3/tests/cluster/etl/test_delete_data_loader.py`

 * *Files identical despite different names*

### Comparing `spetlr-5.1.2/tests/cluster/etl/test_deltaupsert.py` & `spetlr-5.1.3/tests/cluster/etl/test_deltaupsert.py`

 * *Files identical despite different names*

### Comparing `spetlr-5.1.2/tests/cluster/etl/test_extractor.py` & `spetlr-5.1.3/tests/cluster/etl/test_extractor.py`

 * *Files identical despite different names*

### Comparing `spetlr-5.1.2/tests/cluster/etl/test_incremental_extractor.py` & `spetlr-5.1.3/tests/cluster/etl/test_incremental_extractor.py`

 * *Files identical despite different names*

### Comparing `spetlr-5.1.2/tests/cluster/etl/test_loader.py` & `spetlr-5.1.3/tests/cluster/etl/test_loader.py`

 * *Files identical despite different names*

### Comparing `spetlr-5.1.2/tests/cluster/etl/test_orchestrator_etl_warning.py` & `spetlr-5.1.3/tests/cluster/etl/test_orchestrator_etl_warning.py`

 * *Files identical despite different names*

### Comparing `spetlr-5.1.2/tests/cluster/etl/test_simpleloader_upsert.py` & `spetlr-5.1.3/tests/cluster/etl/test_simpleloader_upsert.py`

 * *Files identical despite different names*

### Comparing `spetlr-5.1.2/tests/cluster/etl/test_upsertloader.py` & `spetlr-5.1.3/tests/cluster/etl/test_upsertloader.py`

 * *Files identical despite different names*

### Comparing `spetlr-5.1.2/tests/cluster/etl/test_upsertloader_streaming.py` & `spetlr-5.1.3/tests/cluster/etl/test_upsertloader_streaming.py`

 * *Files identical despite different names*

### Comparing `spetlr-5.1.2/tests/cluster/filehandle/test_filehandle.py` & `spetlr-5.1.3/tests/cluster/filehandle/test_filehandle.py`

 * *Files identical despite different names*

### Comparing `spetlr-5.1.2/tests/cluster/loaders/test_scd2_loader.py` & `spetlr-5.1.3/tests/cluster/loaders/test_scd2_loader.py`

 * *Files identical despite different names*

### Comparing `spetlr-5.1.2/tests/cluster/reporting/test_slack_reporting.py` & `spetlr-5.1.3/tests/cluster/reporting/test_slack_reporting.py`

 * *Files identical despite different names*

### Comparing `spetlr-5.1.2/tests/cluster/schema_manager/test_schema_manager.py` & `spetlr-5.1.3/tests/cluster/schema_manager/test_schema_manager.py`

 * *Files identical despite different names*

### Comparing `spetlr-5.1.2/tests/cluster/sql/test_deliveryexecutor.py` & `spetlr-5.1.3/tests/cluster/sql/test_deliveryexecutor.py`

 * *Files identical despite different names*

### Comparing `spetlr-5.1.2/tests/cluster/sql/test_deliverysql.py` & `spetlr-5.1.3/tests/cluster/sql/test_deliverysql.py`

 * *Files identical despite different names*

### Comparing `spetlr-5.1.2/tests/cluster/sql/test_simple_sql_etl.py` & `spetlr-5.1.3/tests/cluster/sql/test_simple_sql_etl.py`

 * *Files identical despite different names*

### Comparing `spetlr-5.1.2/tests/cluster/sql/test_sql_streaming.py` & `spetlr-5.1.3/tests/cluster/sql/test_sql_streaming.py`

 * *Files identical despite different names*

### Comparing `spetlr-5.1.2/tests/cluster/sql/test_sqlhandle.py` & `spetlr-5.1.3/tests/cluster/sql/test_sqlhandle.py`

 * *Files identical despite different names*

### Comparing `spetlr-5.1.2/tests/cluster/transformations/test_merge_df_into_target.py` & `spetlr-5.1.3/tests/cluster/transformations/test_merge_df_into_target.py`

 * *Files identical despite different names*

### Comparing `spetlr-5.1.2/tests/cluster/transformations/test_simple_sql_transformer.py` & `spetlr-5.1.3/tests/cluster/transformations/test_simple_sql_transformer.py`

 * *Files identical despite different names*

### Comparing `spetlr-5.1.2/tests/cluster/transformations/test_union_transformer.py` & `spetlr-5.1.3/tests/cluster/transformations/test_union_transformer.py`

 * *Files identical despite different names*

### Comparing `spetlr-5.1.2/tests/cluster/utils/test_delete_schema_mismatch.py` & `spetlr-5.1.3/tests/cluster/utils/test_delete_schema_mismatch.py`

 * *Files identical despite different names*

### Comparing `spetlr-5.1.2/tests/cluster/utils/test_spark_version.py` & `spetlr-5.1.3/tests/cluster/utils/test_spark_version.py`

 * *Files identical despite different names*

### Comparing `spetlr-5.1.2/tests/cluster/utils/test_stop_test_stream.py` & `spetlr-5.1.3/tests/cluster/utils/test_stop_test_stream.py`

 * *Files identical despite different names*

### Comparing `spetlr-5.1.2/tests/local/azure_log_analytics/test_azure_log_analytics_handle.py` & `spetlr-5.1.3/tests/local/azure_log_analytics/test_azure_log_analytics_handle.py`

 * *Files identical despite different names*

### Comparing `spetlr-5.1.2/tests/local/configurator/test_configurator.py` & `spetlr-5.1.3/tests/local/configurator/test_configurator.py`

 * *Files identical despite different names*

### Comparing `spetlr-5.1.2/tests/local/configurator/test_configurator_cli.py` & `spetlr-5.1.3/tests/local/configurator/test_configurator_cli.py`

 * *Files identical despite different names*

### Comparing `spetlr-5.1.2/tests/local/delta/test_DeltaDatabaseSpec.py` & `spetlr-5.1.3/tests/local/delta/test_DeltaDatabaseSpec.py`

 * *Files identical despite different names*

### Comparing `spetlr-5.1.2/tests/local/delta/test_DeltaTableSpec.py` & `spetlr-5.1.3/tests/local/delta/test_DeltaTableSpec.py`

 * *Files identical despite different names*

### Comparing `spetlr-5.1.2/tests/local/delta/test_table_name.py` & `spetlr-5.1.3/tests/local/delta/test_table_name.py`

 * *Files identical despite different names*

### Comparing `spetlr-5.1.2/tests/local/eh/test_EventHubCaptureExtractor.py` & `spetlr-5.1.3/tests/local/eh/test_EventHubCaptureExtractor.py`

 * *Files identical despite different names*

### Comparing `spetlr-5.1.2/tests/local/eh/test_ehto_bronze_and_silver.py` & `spetlr-5.1.3/tests/local/eh/test_ehto_bronze_and_silver.py`

 * *Files identical despite different names*

### Comparing `spetlr-5.1.2/tests/local/eh/test_ehtodeltabronze_orchestrator.py` & `spetlr-5.1.3/tests/local/eh/test_ehtodeltabronze_orchestrator.py`

 * *Files identical despite different names*

### Comparing `spetlr-5.1.2/tests/local/eh/test_ehtodeltabronze_transformer.py` & `spetlr-5.1.3/tests/local/eh/test_ehtodeltabronze_transformer.py`

 * *Files identical despite different names*

### Comparing `spetlr-5.1.2/tests/local/eh/test_ehtodeltasilver_orchestrator.py` & `spetlr-5.1.3/tests/local/eh/test_ehtodeltasilver_orchestrator.py`

 * *Files identical despite different names*

### Comparing `spetlr-5.1.2/tests/local/entry_points/test_generalized_entry_points.py` & `spetlr-5.1.3/tests/local/entry_points/test_generalized_entry_points.py`

 * *Files identical despite different names*

### Comparing `spetlr-5.1.2/tests/local/etl/log/log_transformers/test_count_log_transformer.py` & `spetlr-5.1.3/tests/local/etl/log/log_transformers/test_count_log_transformer.py`

 * *Files identical despite different names*

### Comparing `spetlr-5.1.2/tests/local/etl/log/log_transformers/test_null_log_transformer.py` & `spetlr-5.1.3/tests/local/etl/log/log_transformers/test_null_log_transformer.py`

 * *Files identical despite different names*

### Comparing `spetlr-5.1.2/tests/local/etl/log/test_log_orchestrator.py` & `spetlr-5.1.3/tests/local/etl/log/test_log_orchestrator.py`

 * *Files identical despite different names*

### Comparing `spetlr-5.1.2/tests/local/etl/log/test_log_transformer.py` & `spetlr-5.1.3/tests/local/etl/log/test_log_transformer.py`

 * *Files identical despite different names*

### Comparing `spetlr-5.1.2/tests/local/etl/test_lazy_extractor.py` & `spetlr-5.1.3/tests/local/etl/test_lazy_extractor.py`

 * *Files identical despite different names*

### Comparing `spetlr-5.1.2/tests/local/etl/test_transformer.py` & `spetlr-5.1.3/tests/local/etl/test_transformer.py`

 * *Files identical despite different names*

### Comparing `spetlr-5.1.2/tests/local/extractors/test_eventhub_stream_extractor.py` & `spetlr-5.1.3/tests/local/extractors/test_eventhub_stream_extractor.py`

 * *Files identical despite different names*

### Comparing `spetlr-5.1.2/tests/local/filehandle/test_filehandle.py` & `spetlr-5.1.3/tests/local/filehandle/test_filehandle.py`

 * *Files identical despite different names*

### Comparing `spetlr-5.1.2/tests/local/power_bi/test_power_bi.py` & `spetlr-5.1.3/tests/local/power_bi/test_power_bi.py`

 * *Files identical despite different names*

### Comparing `spetlr-5.1.2/tests/local/reporting/test_slack_reporting.py` & `spetlr-5.1.3/tests/local/reporting/test_slack_reporting.py`

 * *Files identical despite different names*

### Comparing `spetlr-5.1.2/tests/local/repr/test_repr_sql_types.py` & `spetlr-5.1.3/tests/local/repr/test_repr_sql_types.py`

 * *Files identical despite different names*

### Comparing `spetlr-5.1.2/tests/local/schema_manager/test_schema_manager.py` & `spetlr-5.1.3/tests/local/schema_manager/test_schema_manager.py`

 * *Files identical despite different names*

### Comparing `spetlr-5.1.2/tests/local/sql/test_SqlExecutor.py` & `spetlr-5.1.3/tests/local/sql/test_SqlExecutor.py`

 * *Files identical despite different names*

### Comparing `spetlr-5.1.2/tests/local/streaming/test_stream_loader.py` & `spetlr-5.1.3/tests/local/streaming/test_stream_loader.py`

 * *Files identical despite different names*

### Comparing `spetlr-5.1.2/tests/local/test_functions.py` & `spetlr-5.1.3/tests/local/test_functions.py`

 * *Files identical despite different names*

### Comparing `spetlr-5.1.2/tests/local/test_get_schema.py` & `spetlr-5.1.3/tests/local/test_get_schema.py`

 * *Files identical despite different names*

### Comparing `spetlr-5.1.2/tests/local/test_sqlServer.py` & `spetlr-5.1.3/tests/local/test_sqlServer.py`

 * *Files identical despite different names*

### Comparing `spetlr-5.1.2/tests/local/test_transformations.py` & `spetlr-5.1.3/tests/local/test_transformations.py`

 * *Files identical despite different names*

### Comparing `spetlr-5.1.2/tests/local/transformers/test_clean_column_names_transformer.py` & `spetlr-5.1.3/tests/local/transformers/test_clean_column_names_transformer.py`

 * *Files identical despite different names*

### Comparing `spetlr-5.1.2/tests/local/transformers/test_concat_df.py` & `spetlr-5.1.3/tests/local/transformers/test_concat_df.py`

 * *Files identical despite different names*

### Comparing `spetlr-5.1.2/tests/local/transformers/test_country_to_alphacode_transformer.py` & `spetlr-5.1.3/tests/local/transformers/test_country_to_alphacode_transformer.py`

 * *Files identical despite different names*

### Comparing `spetlr-5.1.2/tests/local/transformers/test_data_change_capture_transformer.py` & `spetlr-5.1.3/tests/local/transformers/test_data_change_capture_transformer.py`

 * *Files identical despite different names*

### Comparing `spetlr-5.1.2/tests/local/transformers/test_drop_columns.py` & `spetlr-5.1.3/tests/local/transformers/test_drop_columns.py`

 * *Files identical despite different names*

### Comparing `spetlr-5.1.2/tests/local/transformers/test_dropoldestduplicates.py` & `spetlr-5.1.3/tests/local/transformers/test_dropoldestduplicates.py`

 * *Files identical despite different names*

### Comparing `spetlr-5.1.2/tests/local/transformers/test_fuzzy_select.py` & `spetlr-5.1.3/tests/local/transformers/test_fuzzy_select.py`

 * *Files identical despite different names*

### Comparing `spetlr-5.1.2/tests/local/transformers/test_generate_md5_column_transformer.py` & `spetlr-5.1.3/tests/local/transformers/test_generate_md5_column_transformer.py`

 * *Files identical despite different names*

### Comparing `spetlr-5.1.2/tests/local/transformers/test_join_dataframes_transformer.py` & `spetlr-5.1.3/tests/local/transformers/test_join_dataframes_transformer.py`

 * *Files identical despite different names*

### Comparing `spetlr-5.1.2/tests/local/transformers/test_select_and_cast_columns_transformer.py` & `spetlr-5.1.3/tests/local/transformers/test_select_and_cast_columns_transformer.py`

 * *Files identical despite different names*

### Comparing `spetlr-5.1.2/tests/local/transformers/test_select_columns.py` & `spetlr-5.1.3/tests/local/transformers/test_select_columns.py`

 * *Files identical despite different names*

### Comparing `spetlr-5.1.2/tests/local/transformers/test_simple_dataframe_filter_transformer.py` & `spetlr-5.1.3/tests/local/transformers/test_simple_dataframe_filter_transformer.py`

 * *Files identical despite different names*

### Comparing `spetlr-5.1.2/tests/local/transformers/test_timezone_transformer.py` & `spetlr-5.1.3/tests/local/transformers/test_timezone_transformer.py`

 * *Files identical despite different names*

### Comparing `spetlr-5.1.2/tests/local/transformers/test_union_transformer.py` & `spetlr-5.1.3/tests/local/transformers/test_union_transformer.py`

 * *Files identical despite different names*

### Comparing `spetlr-5.1.2/tests/local/transformers/test_validfromto_transformer.py` & `spetlr-5.1.3/tests/local/transformers/test_validfromto_transformer.py`

 * *Files identical despite different names*

### Comparing `spetlr-5.1.2/tests/local/utils/test_dataframe_creation.py` & `spetlr-5.1.3/tests/local/utils/test_dataframe_creation.py`

 * *Files identical despite different names*

### Comparing `spetlr-5.1.2/tests/local/utils/test_dropoldestduplicates.py` & `spetlr-5.1.3/tests/local/utils/test_dropoldestduplicates.py`

 * *Files identical despite different names*

### Comparing `spetlr-5.1.2/tests/local/utils/test_getmergestatement.py` & `spetlr-5.1.3/tests/local/utils/test_getmergestatement.py`

 * *Files identical despite different names*

### Comparing `spetlr-5.1.2/tests/local/utils/test_md5_hashcolumn.py` & `spetlr-5.1.3/tests/local/utils/test_md5_hashcolumn.py`

 * *Files identical despite different names*

### Comparing `spetlr-5.1.2/tests/local/utils/test_mock_etl.py` & `spetlr-5.1.3/tests/local/utils/test_mock_etl.py`

 * *Files identical despite different names*

### Comparing `spetlr-5.1.2/tests/local/utils/test_selectandcastcolumns.py` & `spetlr-5.1.3/tests/local/utils/test_selectandcastcolumns.py`
