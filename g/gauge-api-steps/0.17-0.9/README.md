# Comparing `tmp/gauge-api-steps-0.17.tar.gz` & `tmp/gauge-api-steps-0.9.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "gauge-api-steps-0.17.tar", last modified: Fri Apr 19 15:24:18 2024, max compression
+gzip compressed data, was "gauge-api-steps-0.9.tar", last modified: Mon Jul 31 14:43:38 2023, max compression
```

## Comparing `gauge-api-steps-0.17.tar` & `gauge-api-steps-0.9.tar`

### file list

```diff
@@ -1,20 +1,17 @@
-drwxr-xr-x   0 runner    (1001) docker     (127)        0 2024-04-19 15:24:18.357375 gauge-api-steps-0.17/
--rw-r--r--   0 runner    (1001) docker     (127)     1088 2024-04-19 15:24:08.000000 gauge-api-steps-0.17/LICENCE
--rw-r--r--   0 runner    (1001) docker     (127)     6384 2024-04-19 15:24:18.357375 gauge-api-steps-0.17/PKG-INFO
--rw-r--r--   0 runner    (1001) docker     (127)     5871 2024-04-19 15:24:08.000000 gauge-api-steps-0.17/README.md
-drwxr-xr-x   0 runner    (1001) docker     (127)        0 2024-04-19 15:24:18.357375 gauge-api-steps-0.17/gauge_api_steps/
--rw-r--r--   0 runner    (1001) docker     (127)       63 2024-04-19 15:24:08.000000 gauge-api-steps-0.17/gauge_api_steps/__init__.py
--rw-r--r--   0 runner    (1001) docker     (127)    17032 2024-04-19 15:24:08.000000 gauge-api-steps-0.17/gauge_api_steps/api_steps.py
--rw-r--r--   0 runner    (1001) docker     (127)      379 2024-04-19 15:24:08.000000 gauge-api-steps-0.17/gauge_api_steps/file_util.py
--rw-r--r--   0 runner    (1001) docker     (127)     2485 2024-04-19 15:24:08.000000 gauge-api-steps-0.17/gauge_api_steps/session.py
--rw-r--r--   0 runner    (1001) docker     (127)     3737 2024-04-19 15:24:08.000000 gauge-api-steps-0.17/gauge_api_steps/substitute.py
-drwxr-xr-x   0 runner    (1001) docker     (127)        0 2024-04-19 15:24:18.357375 gauge-api-steps-0.17/gauge_api_steps.egg-info/
--rw-r--r--   0 runner    (1001) docker     (127)     6384 2024-04-19 15:24:18.000000 gauge-api-steps-0.17/gauge_api_steps.egg-info/PKG-INFO
--rw-r--r--   0 runner    (1001) docker     (127)      416 2024-04-19 15:24:18.000000 gauge-api-steps-0.17/gauge_api_steps.egg-info/SOURCES.txt
--rw-r--r--   0 runner    (1001) docker     (127)        1 2024-04-19 15:24:18.000000 gauge-api-steps-0.17/gauge_api_steps.egg-info/dependency_links.txt
--rw-r--r--   0 runner    (1001) docker     (127)        1 2024-04-19 15:24:18.000000 gauge-api-steps-0.17/gauge_api_steps.egg-info/not-zip-safe
--rw-r--r--   0 runner    (1001) docker     (127)       48 2024-04-19 15:24:18.000000 gauge-api-steps-0.17/gauge_api_steps.egg-info/requires.txt
--rw-r--r--   0 runner    (1001) docker     (127)       16 2024-04-19 15:24:18.000000 gauge-api-steps-0.17/gauge_api_steps.egg-info/top_level.txt
--rw-r--r--   0 runner    (1001) docker     (127)       48 2024-04-19 15:24:08.000000 gauge-api-steps-0.17/pyproject.toml
--rw-r--r--   0 runner    (1001) docker     (127)       38 2024-04-19 15:24:18.357375 gauge-api-steps-0.17/setup.cfg
--rw-r--r--   0 runner    (1001) docker     (127)      857 2024-04-19 15:24:08.000000 gauge-api-steps-0.17/setup.py
...
### Comparing `gauge-api-steps-0.17/LICENCE` & `gauge-api-steps-0.9/LICENCE`

 * *Files identical despite different names*

### Comparing `gauge-api-steps-0.17/gauge_api_steps/api_steps.py` & `gauge-api-steps-0.9/gauge_api_steps/api_steps.py`
...
### Comparing `gauge-api-steps-0.17/setup.py` & `gauge-api-steps-0.9/setup.py`
