# Comparing `tmp/multidecoder-1.2.2.tar.gz` & `tmp/multidecoder-1.3.0.tar.gz`
...
### Comparing `multidecoder-1.2.2/.gitignore` & `multidecoder-1.3.0/.gitignore`
...
### Comparing `multidecoder-1.2.2/src/multidecoder/json_conversion.py` & `multidecoder-1.3.0/src/multidecoder/json_conversion.py`
...
### Comparing `multidecoder-1.2.2/src/multidecoder/keywords/api/api.libeay32` & `multidecoder-1.3.0/src/multidecoder/keywords/api/api.libeay32`
...
### Comparing `multidecoder-1.2.2/src/multidecoder/keywords/key` & `multidecoder-1.3.0/src/multidecoder/keywords/key`

 * *Files identical despite different names*

### Comparing `multidecoder-1.2.2/src/multidecoder/keywords/network.string` & `multidecoder-1.3.0/src/multidecoder/keywords/network.string`

 * *Files identical despite different names*

### Comparing `multidecoder-1.2.2/src/multidecoder/keywords/oid` & `multidecoder-1.3.0/src/multidecoder/keywords/oid`

 * *Files identical despite different names*

### Comparing `multidecoder-1.2.2/src/multidecoder/keywords/os_name` & `multidecoder-1.3.0/src/multidecoder/keywords/os_name`

 * *Files identical despite different names*

### Comparing `multidecoder-1.2.2/src/multidecoder/keywords/powershell.cmdlet` & `multidecoder-1.3.0/src/multidecoder/keywords/powershell.cmdlet`

 * *Files identical despite different names*

### Comparing `multidecoder-1.2.2/src/multidecoder/keywords/privilege` & `multidecoder-1.3.0/src/multidecoder/keywords/privilege`

 * *Files identical despite different names*

### Comparing `multidecoder-1.2.2/src/multidecoder/keywords/ransomware.string` & `multidecoder-1.3.0/src/multidecoder/keywords/ransomware.string`

 * *Files identical despite different names*

### Comparing `multidecoder-1.2.2/src/multidecoder/keywords/security_identifier` & `multidecoder-1.3.0/src/multidecoder/keywords/security_identifier`

 * *Files identical despite different names*

### Comparing `multidecoder-1.2.2/src/multidecoder/keywords/windows.registry` & `multidecoder-1.3.0/src/multidecoder/keywords/windows.registry`

 * *Files identical despite different names*

### Comparing `multidecoder-1.2.2/src/multidecoder/keywords_to_review.txt` & `multidecoder-1.3.0/src/multidecoder/keywords_to_review.txt`

 * *Files identical despite different names*

### Comparing `multidecoder-1.2.2/src/multidecoder/multidecoder.py` & `multidecoder-1.3.0/src/multidecoder/multidecoder.py`

 * *Files identical despite different names*

### Comparing `multidecoder-1.2.2/src/multidecoder/node.py` & `multidecoder-1.3.0/src/multidecoder/node.py`

 * *Files identical despite different names*

### Comparing `multidecoder-1.2.2/src/multidecoder/query.py` & `multidecoder-1.3.0/src/multidecoder/query.py`

 * *Files identical despite different names*

### Comparing `multidecoder-1.2.2/src/multidecoder/registry.py` & `multidecoder-1.3.0/src/multidecoder/registry.py`

 * *Files identical despite different names*

### Comparing `multidecoder-1.2.2/src/multidecoder/xor_helper.py` & `multidecoder-1.3.0/src/multidecoder/xor_helper.py`

 * *Files identical despite different names*

### Comparing `multidecoder-1.2.2/src/multidecoder.egg-info/PKG-INFO` & `multidecoder-1.3.0/src/multidecoder.egg-info/PKG-INFO`
...
### Comparing `multidecoder-1.2.2/src/multidecoder.egg-info/SOURCES.txt` & `multidecoder-1.3.0/src/multidecoder.egg-info/SOURCES.txt`

 * *Files identical despite different names*

### Comparing `multidecoder-1.2.2/tests/test_decoders/test_base64.py` & `multidecoder-1.3.0/tests/test_decoders/test_base64.py`

 * *Files identical despite different names*

### Comparing `multidecoder-1.2.2/tests/test_decoders/test_chr.py` & `multidecoder-1.3.0/tests/test_decoders/test_chr.py`

 * *Files identical despite different names*

### Comparing `multidecoder-1.2.2/tests/test_decoders/test_concat.py` & `multidecoder-1.3.0/tests/test_decoders/test_concat.py`

 * *Files identical despite different names*

### Comparing `multidecoder-1.2.2/tests/test_decoders/test_encoding.py` & `multidecoder-1.3.0/tests/test_decoders/test_encoding.py`

 * *Files identical despite different names*

### Comparing `multidecoder-1.2.2/tests/test_decoders/test_hex.py` & `multidecoder-1.3.0/tests/test_decoders/test_hex.py`

 * *Files identical despite different names*

### Comparing `multidecoder-1.2.2/tests/test_decoders/test_network.py` & `multidecoder-1.3.0/tests/test_decoders/test_network.py`

 * *Files identical despite different names*

### Comparing `multidecoder-1.2.2/tests/test_decoders/test_path.py` & `multidecoder-1.3.0/tests/test_decoders/test_path.py`

 * *Files identical despite different names*

### Comparing `multidecoder-1.2.2/tests/test_decoders/test_replace.py` & `multidecoder-1.3.0/tests/test_decoders/test_replace.py`

 * *Files identical despite different names*

### Comparing `multidecoder-1.2.2/tests/test_decoders/test_shell.py` & `multidecoder-1.3.0/tests/test_decoders/test_shell.py`

 * *Files identical despite different names*

### Comparing `multidecoder-1.2.2/tests/test_decoders/test_vba.py` & `multidecoder-1.3.0/tests/test_decoders/test_vba.py`

 * *Files identical despite different names*

### Comparing `multidecoder-1.2.2/tests/test_decoders/test_xml.py` & `multidecoder-1.3.0/tests/test_decoders/test_xml.py`

 * *Files identical despite different names*

### Comparing `multidecoder-1.2.2/tests/test_multidecoder.py` & `multidecoder-1.3.0/tests/test_multidecoder.py`

 * *Files identical despite different names*

### Comparing `multidecoder-1.2.2/tests/test_node.py` & `multidecoder-1.3.0/tests/test_node.py`

 * *Files identical despite different names*

### Comparing `multidecoder-1.2.2/tests/test_xor_helper.py` & `multidecoder-1.3.0/tests/test_xor_helper.py`
